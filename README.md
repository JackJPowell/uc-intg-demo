# Unfolded Circle Integration Demo

A demo repository for creating [Unfolded Circle Remote Two/3](https://www.unfoldedcircle.com/) integration drivers using the [ucapi-framework](https://github.com/jackjpowell/ucapi-framework).

## Getting Started

1. **Clone or use this demo** to create your own integration repository
2. **Rename the integration folder** from `intg-demo` to `intg-yourdevice`
3. **Update the following files** with your device-specific information:
   ...
   - `intg-demo/const.py` - Device configuration and constants
   - `intg-demo/device.py` - Device communication logic
   - `intg-demo/media_player.py` - Media player entity implementation
   - `intg-demo/setup.py` - Setup flow and configuration forms
   - `intg-demo/discover.py` - Device discovery (if applicable)

## Project Structure

```
├── driver.json              # Integration metadata and configuration
├── intg-demo/           # Main integration code (rename this folder)
...
The demo includes a Media Player entity. To add additional entity types:
