...
> **Note:** Replace `intg-demo` with your integration folder name.

```shell
python -m pylint intg-demo
python -m flake8 intg-demo --count --show-source --statistics
python -m isort intg-demo/. --check --verbose 
python -m black intg-demo --check --verbose --line-length 120
```
...
### Format Code
```shell
python -m black intg-demo --line-length 120
```
